    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    focusedBorderColor = if (signUpData.errorEmailAddress) {ErrorRed} else {GreyColor70},
                    unfocusedBorderColor = if (signUpData.errorEmailAddress) {ErrorRed} else {GreyColor70},
                    cursorColor = AppBlue,
                    focusedTextColor = if (signUpData.errorEmailAddress) {ErrorRed} else {GreyColor30}
                ),
                singleLine = true,
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    focusedBorderColor = if (signUpData.errorConfirmPassword) {ErrorRed} else {GreyColor70},
                    unfocusedBorderColor = if (signUpData.errorConfirmPassword) {ErrorRed} else {GreyColor70},
                    cursorColor = AppBlue,
                    focusedTextColor = if (signUpData.errorConfirmPassword) {ErrorRed} else {GreyColor30}
                ),
                singleLine = true,
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password),
                trailingIcon = {
